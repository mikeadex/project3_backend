...
class Opportunity(models.Model):
    ...
    opportunity_type = models.CharField(
        max_length=20, choices=OPPORTUNITY_TYPES, default="job"
    )
    ...
    experience_level = models.CharField(
        max_length=20, choices=EXPERIENCE_LEVEL, default="no_experience"
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["title", "employer", "location"], name="job_duplicate_idx"
            ),
...
class JobApplication(models.Model):
    ...
    cv_used = models.ForeignKey(
        "cv_writer.CvWriter", on_delete=models.SET_NULL, null=True, blank=True
    )
