# Help Center Articles - Quick Reference
...
- Downloadable formats with proper naming
...
- `export`, `download`, `pdf`, `docx`, `formats` (Article 4)
...
- ✅ **Export formats:** PDF/DOCX/TXT match actual export functionality
- ✅ **AI features:** Matches `cvImprovementService` and rewrite functionality
- ✅ **Free vs Premium:** Accurately reflects pricing tiers
...
4. **AI Improvements** → Apply suggestions
...
- "Can I download as Word?" → Article 4
- "How does AI help?" → Article 5
...
- [ ] Create all tags (19 unique tags)
...
5. **Industry-Specific Guides**
   ...
   - Finance industry CV best practices
   - Creative field CV strategies
...
- "Export issues" → Send Download guide
...
- Before expiry → Premium features deep dive
...
- ✅ Clear next steps in each article
- ✅ Mobile-friendly content structure

---

**Status:** ✅ Ready for Django Admin deployment  
**Estimated Setup Time:** 20-30 minutes  
**Maintenance Required:** Low (monthly updates)

**All files located at:** `/Users/michaeladeleye/Documents/Coding/ella/Ella-backend/help-articles/`
